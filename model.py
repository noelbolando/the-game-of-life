"""Defines the model itself, initialized with a random configuration of ALIVE and DEAD cells."""
...
class ConwaysGameOfLife(Model):
    ...
    def __init__(self, width=30, height=30, initial_fraction_alive=0.2, seed=None):
